...
<head>
    ...
    <title>Login | Applicant Portal</title>
        ...
        <section class="auth-card row g-0">
            <div class="col-lg-8 hero-panel">
                <div class="hero-content">
                    ...
                    <h1 class="brand-title">Track your requirements with ease.</h1>
                    <p class="hero-copy">
                        Log in securely to submit files, monitor your application status, and stay updated on every
                        step of the process.
                    </p>
                    ...
                    <ul class="feature-list">
                        <li class="feature-item">
                            ...
                            Upload and manage your applicant files
                        </li>
                        <li class="feature-item">
                            <span class="feature-icon">✓</span>
