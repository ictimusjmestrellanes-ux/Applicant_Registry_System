                        ...
                        <form action="{{ route('applicants.update', $applicant->id) }}" method="POST">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="or_no" value="{{ $applicant->or_no }}" class="form-control"
                                        required>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="barangay" id="barangay" class="form-select"></select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="educational_attainment"
                                        value="{{ $applicant->educational_attainment }}" class="form-control">
                                </div>
                                ...
                                {{-- POSITION --}}
                                <div class="col-md-4">
                                    <label class="form-label">Position Hired</label>
                ...
                <div class="tab-pane fade" id="permit">
                    ...
                    <form action="{{ route('permits.update', $applicant->id) }}" method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">NBI / Police Clearance</label>
                ...
                <div class="tab-pane fade" id="clearance">
                    ...
                    <form action="{{ route('clearances.update', $applicant->id) }}" method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Prosecutor Clearance</label>
